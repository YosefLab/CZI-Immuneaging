...
working_dir = sys.argv[5] # must be either "" or the absolute path to the local directory where we will temporarily place the logs downloaded from aws - only used if logs_location is "aws"
