...
* `"corresponding_gex_lib"` - The library ID of th GEX lib that corresponds to this library (i.e. sequenced GEX data for the same cells). Relevant only for BCR and TCR libraries - for other lib types this is the same as library_id.
